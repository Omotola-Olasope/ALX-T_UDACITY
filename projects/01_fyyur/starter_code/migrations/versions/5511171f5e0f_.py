...
Revision ID: 5511171f5e0f
Revises: 
Create Date: 2022-05-30 08:29:51.111578
...
def upgrade():
    ...
    sa.Column('seeking_venue', sa.Boolean(), default=False, nullable=True),
    ...
    sa.Column('image_link', sa.String(length=500), nullable=False),
    sa.Column('website', sa.String(), nullable=True),
    sa.Column('seeking_talent', sa.Boolean(), default=False, nullable=True),
    sa.Column('seeking_description', sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
